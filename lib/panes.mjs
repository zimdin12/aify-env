...
export function clipToWidth(text, size) {
  ...
  // RESET AFTER A CUT, if anything was left open. A clipped line that ends mid-colour would tint the
  // divider and the pane beside it.
  return new RegExp(SGR).test(out) ? `${out}${RESET}` : out;
}

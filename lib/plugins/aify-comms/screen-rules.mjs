...
//
// IN THE PLUGIN, NOT THE HOST. aify-env's general code keeps its standing rule that it does not read
// agent screens for meaning (`lib/activity.mjs`). This is runtime knowledge carried for aify-comms, so
// it lives with the aify-comms plugin; the host only offers screen text.
//

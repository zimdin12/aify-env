...
async function startTerminal({
  ...
  if (live.length) {
    ...
    if (standing === "ended" || standing === "gone") {
      ...
      const adopted = carryTerminal({ processes, api, handles, log, terminalId, handle, sender });
      if (!adopted) {
  ...
  const carried = carryTerminal({ processes, api, handles, log, terminalId, handle, sender });
 ...
 */
function carryTerminal({ processes, api, handles, log, terminalId, handle, sender }) {

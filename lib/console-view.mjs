...
export function paneTitle(pane, width, height = 0) {
  ...
  const producerRows = Number(pane?.screenRows) || 0;
  const rowsCropped = producerRows > 0 && height > 0 && producerRows > height
    ? [` · ${producerRows} rows, cropped`, ` · ${producerRows}r cropped`]
    : null;
